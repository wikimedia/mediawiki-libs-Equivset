...
class EquivsetTest extends TestCase {
	...
	public function testLoadFailNoFile() {
		...
		$this->setExpectedException( EquivsetException::class, 'Serialized equivset is missing' );
		$equivset->all();
	}
	...
	public function testLoadFailUnreadableFile() {
		...
		$this->setExpectedException( EquivsetException::class, 'Serialized equivset is unreadable' );
		$equivset->all();
	}
